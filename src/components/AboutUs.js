const AboutUs=()=>{
    return (
        <div className="mx-32 my-40 bg-black text-white rounded-3xl p-6 h-[170%]">
            <h1 className="text-bold text-3xl underline">ABOUT US</h1>
